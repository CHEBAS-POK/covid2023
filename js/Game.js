class Game {
  constructor() {
    ...
    this.leadeboarTitle = createElement("h2");
...
this.addSprites(obstacles, obstaclesPositions.length, obstacle1Image, 0.04, obstaclesPositions);
  ...
  handleElements(){
    ...
    this.leadeboarTitle.html("Puntuación");
    this.leadeboarTitle.class("resetText");
    this.leadeboarTitle.position(width/3 -60, 40);
    ...
    if(allPlayers !== undefined){
      ...
      for (var plr in allPlayers){
        ...
        if(index === player.index){
          ...
          //Cambiar la posición de la camara
